...
const DefaultConfigurations = {
  ...
  custom: {
    ...
    thumbnail: {
      ...
      textShadow:
        "0 1px 0 #ccc,0 1px 3px rgba(0,0,0,.1), 0 10px 10px rgba(0,0,0,.1), 0 20px 20px rgba(0,0,0,.1)",
      offset: 0.4, // Ratio between dark and light gradient, don't want a gradient make it 0
      colorMap: {
        // Any hashed color code or if you remove a mapping will fallback to default
        a: "#CC5262",
        b: "#605F42",
        c: "#474675",
        d: "#F39137",
    ...
    landingPage: {
      ...
      contact: {
        active: true,
        contactHTML:
          "<div><strong>Mailing Address</strong><p><div>787 Castro Street</div><div>Mountain View,</div><div>CA 94041</div></p><div>Tel: +1 650 745 4499 </div><div>Fax: +1 650 584 3894</div></div>",
      },
    },
    tagWise: {
      active: false,
